...
class ChatStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SendMessage = channel.unary_unary(
                ...
                response_deserializer=chat__pb2.Vazio.FromString,
                )
        self.ReceiveMessages = channel.unary_stream(
                '/chat.Chat/ReceiveMessages',
                request_serializer=chat__pb2.Vazio.SerializeToString,
...
def add_ChatServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SendMessage': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=chat__pb2.Vazio.SerializeToString,
            ),
            'ReceiveMessages': grpc.unary_stream_rpc_method_handler(
                    servicer.ReceiveMessages,
                    request_deserializer=chat__pb2.Vazio.FromString,
...
class Chat(object):
    ...
    def ReceiveMessages(request,
        ...
        return grpc.experimental.unary_stream(request, target, '/chat.Chat/ReceiveMessages',
            chat__pb2.Vazio.SerializeToString,
